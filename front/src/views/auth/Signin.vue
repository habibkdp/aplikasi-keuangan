              ...
              <div>
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <p class="text-red-500 text-xs mt-1.5" v-if="errors && errors.email"
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <p class="text-red-500 text-xs mt-1.5" v-if="errors && errors.password"
                          v-for="error in errors.password">{{
                            error }}</p>
                        <p class="text-red-500 text-xs mt-1.5" v-if="errors && errors.error"
                          v-for="error in errors.error">{{ error }}
                        </p>
                      </div>
                    </div>
                    <!-- Checkbox -->
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <router-link to="/register" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign
                      Up</router-link>
                  </p>
                </div>
              </div>
